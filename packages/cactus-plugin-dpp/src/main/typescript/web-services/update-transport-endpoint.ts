...
export class UpdateTransportEndpoint implements IWebServiceEndpoint {
  public static readonly CLASS_NAME = "UpdateTransportEndpoint";

  private readonly log: Logger;

  public get className(): string {
    return UpdateTransportEndpoint.CLASS_NAME;
  }

  constructor(public readonly options: IUpdateTransportEndpointOptions) {
  ...
  public getPath(): string {
    return "/api/v1/@hyperledger/cactus-plugin-dpp/update-transport";
  }
